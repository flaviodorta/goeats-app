...
export default function RestaurantMenuScreen() {
  ...
  const route = useRoute<RouteProp<RootStackParamList, 'RestaurantMenu'>>();
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <View
        ...
        style={{ height: 220, backgroundColor: `${restaurant.iconColor}20`, paddingTop: insets.top }}
      >
        <MaterialCommunityIcons name={restaurant.iconName as any} size={90} color={restaurant.iconColor} style={{ opacity: 0.7 }} />
        ...
        <View className="absolute flex-row gap-2" style={{ top: insets.top + 12, right: 16 }}>
          <TouchableOpacity
      ...
      {/* Info card */}
      <View className="bg-surface px-5 py-4" style={{ elevation: 2, shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8 }}>
        <View className="flex-row items-start justify-between">
          ...
          <View className="flex-row items-center rounded-xl px-3 py-1" style={{ backgroundColor: `${Colors.primary}15` }}>
            <MaterialCommunityIcons name="star" size={14} color={Colors.primary} />
            <Text style={{ fontFamily: 'Poppins_700Bold', fontSize: 14, color: Colors.primary, marginLeft: 4 }}>
              {restaurant.rating}
            </Text>
          </View>
        </View>
        ...
        <View className="flex-row items-center mt-3 pt-3 border-t border-border gap-4">
          ...
          <View className="flex-row items-center gap-1">
            <MaterialCommunityIcons name="moped-outline" size={14} color={Colors.textSecondary} />
            <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 12, color: Colors.textSecondary }}>
